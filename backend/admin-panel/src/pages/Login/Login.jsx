...
const getLoginError = (err) => {
  ...
  return err.response.data?.error || 'Falha ao entrar. Tente novamente.';
};
...
export default function Login() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (data.admin.role === 'attendant') {
        setError('Atendentes devem usar o painel de atendimento em /atendente/');
        return;
      }
